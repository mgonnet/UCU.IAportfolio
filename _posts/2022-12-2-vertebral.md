...
Sabiendo que se trata de un problema de clasificación en tres clases, se utiliza el algoritmo de Kmeans de clustering, configurado con K = 3, para analizar que tan separables puedan ser las clases. A continuación se muestran la distribución de las clases dentro de cada cluster.
